...
import Screen from "../../../asset/Booking/screen.png";
import Countdown from "react-countdown";
import Swal from "sweetalert2";
import ListSeat from "../../../Components/ListSeat";
import ATM from "../../../asset/Booking/ATM.png";
import VISA from "../../../asset/Booking/visa_mastercard.png";
import CASH from "../../../asset/Booking/cash.png";
          ...
          <div className="col-md-9 pl-0 pr-0">
            ...
            <header className=" header__booking">
              <nav className="navbar navbar-expand-sm bg-dark navbar-dark">
                {/* Brand/logo */}
                <Link to="/" className="navbar-brand logo-booking">
                  EdricNguyen
                </Link>
